...
public class DetalleService implements DetalleServiceImpl {
    ...
    public DetallesCompletoDTO crearDetalles(DetalleNuevoDTO detalleOrden) {
        ...
        // Ahora que ya tenemos el valor toca actualizar la columna de la base de datos
    ...
    public DetalleSimpleDTO cambiarCantidad(DetalleCantidadDTO detalle) {
        ...
        // -Ahora debemos hacer un cambio en las cantidades, primero debemos saber si la
        // cantidad de cambio
        // -es menor o mayor a la cantidad de refacciones guardadas inicialmente en los
        // detalles
        ...
        if (cantidadDB > cantidadNew) {
            // *Si la cantidad de detalles de la base de datos es mayor al valor nuevo
            // entonces hacemos la resta sobre el de la BD.
            nuevaCantidad = cantidadDB - cantidadNew;
            /*
             * ~~Ahora teniendo el valor de la resta de la cantidad de detalle y el stock
             * tenemos que guardar
             * ~~ el nuevo detalle sumando al stock de base de datos y en detalle hacer el
             * cambio de cantidades.
             * ~~
             */
            detalleO.setCantidad(detalle.getCantidad());
            // Guardamos la nueva cantidad que es la suma del stock mismo + la cantidad que
            // se quería cambiar.
            ...
            log.info("2.El valor de detalles es: {}, y de refacción es: {}", detalleO.getCantidad(),
                    refaccion.getStock());
        } else {
        ...
        // Ahora terminando la funcionalidad toca guardar los datos, esto en refaccion y
        // en detalles.
        reRe.save(refaccion);
